    ...
    <>
        ...
        <div className="container relative">
          <div className="max-w-3xl">
            ...
            <Reveal delay={300} className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="rounded-full bg-white text-forest-800 transition-transform hover:-translate-y-0.5 hover:bg-forest-50">
                <Link href="/donate">
                  Donate Now <ArrowRight size={17} />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-full border-white/40 bg-transparent text-white transition-transform hover:-translate-y-0.5 hover:bg-white/10 hover:text-white">
              ...
              <Reveal key={t} delay={i * 100}>
                <Card className="group overflow-hidden rounded-3xl py-0 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <CardContent className="p-6">
                    ...
                    <Link href="/programs" className="mt-3 inline-flex items-center gap-1 font-bold text-primary transition-[gap] hover:gap-2">
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="my-3 h-2.5 rounded-full bg-muted">
                      <div className="h-full w-3/4 rounded-full bg-primary transition-all duration-700" />
                    </div>
                    <div className="text-sm text-muted-foreground">Goal: ₦10,000,000</div>
                  </div>
                  <Button asChild className="mt-6 rounded-full transition-transform hover:-translate-y-0.5">
      ...
      <section className="section bg-stone-100">
        <div className="container">
          ...
          />
          <Reveal className="mx-auto max-w-xl overflow-hidden rounded-3xl border border-border bg-black">
      ...
      <section className="bg-gradient-to-br from-forest-900 via-forest-700 to-sage-500 py-20 text-white">
        <Reveal className="container flex flex-wrap items-center justify-between gap-8">
          <div>
