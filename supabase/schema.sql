-- The Giving Back Project — Supabase schema
...
insert into public.organization(name,tagline,mission,vision,description,email) values ('The Giving Back Project','Together, we give back.','[NGO Mission Placeholder]','[NGO Vision Placeholder]','[Organization description placeholder]','hello@example.org') on conflict do nothing;
